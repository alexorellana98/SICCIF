<?php
	...
	if(!empty($_POST))
	{
		...
		$activo = 0;
		$tipo_usuario = 2;
		$secret = '6LevAD8UAAAAAIxLrPErLJFblPM44UzMJfdCpMP9';
		...
		if(count($errors) == 0)
		{
			...
			if($arr['success'])
			{
				...
				if($registro > 0 )
				{
					...
					$url = 'http://'.$_SERVER["SERVER_NAME"].'/siccif/vistas/pages/activar.php?id='.$registro.'&val='.$token;
					...
					<div class="panel-body" >
						...
						<form id="signupform" class="form-horizontal" role="form" action="<?php $_SERVER['PHP_SELF'] ?>" method="POST" autocomplete="off">
							...
							<div class="form-group">
								...
								<div class="g-recaptcha col-md-9" data-sitekey="6LevAD8UAAAAAISaO45DxvDrmIRUnqN_Y4gpzCIc"></div>
							</div>
