...
<head>
  <meta charset="UTF-8">
  <title>Categoria Inactivas</title>
...
<script language="javascript">
  ...
  var cond= $("#condi").val();
  if (cond==1) {
     window.location="http://localhost/siccif/vistas/ActivoFijo/Categoria.blade.php";
  }else{window.location="http://localhost/siccif/vistas/ActivoFijo/CategoriaInactivo.blade.php";}
...
<body class="hold-transition skin-green-light sidebar-mini">
  <div class="wrapper">
    ...
    <h3 align="center" >Categorias Inactivas</h3>
    </div>
    </div>
    </div>
    </div>  
...
<thead>
    ...
    <th scope="col" style="color:#FFFFFF">Valor residual(%)</th>
...
{if (($ejecuta['estado'])==0) {
  ...
  <tr>
    ...
    <td>
      ...
      <button disabled="true"  type="submit" class="btn btn-danger" id="btnEditar" name="btnEditar" style="background-color: transparent border:0" data-toggle="modal"  value="<?php echo $ejecuta['idCat']?>" >Editar</button>
    
      
      <form style=" margin-left: 70px; margin-top:-33px;" action="Categoria.blade.php" method="get" class="form-register" > 
     <button  type="submit" class="btn btn-warning" id="btnalta1" name="btnalta1" style="background-color: transparent border:0" data-toggle="modal"  value=<?php echo $ejecuta['idCat'] ?>>Alta</button>
     </form>
    </td>
  </tr>
