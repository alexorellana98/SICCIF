...
<thead>
    ...
    <th scope="col" style="color:#FFFFFF">Codigo Categoria</th>
...
$aux=$ejecuta['idcat'];
  ...
  <tr>
    ...
    <td>
     ...
     <form  style=" margin-left: 70px; margin-top:-33px" action="subcategoria.blade.php" method="get" class="form-register" > 
