...
<head>
  <meta charset="UTF-8">
  <title>Departamento Inactivo</title>
...
<body class="hold-transition skin-green-light sidebar-mini">
  <div class="wrapper">
    ...
    <h3 align="center" >Departamentos Inactivos</h3>
    </div>
    </div>
    </div>
    </div>  
...
{if (($ejecuta['estado'])==0) {
  ...
  <tr>
    ...
    <td>
      ...
      <button disabled="true" type="submit" class="btn btn-danger" id="btnEditar" name="btnEditar" style="background-color: transparent border:0" data-toggle="modal"  value="<?php echo $ejecuta['idDep']?>" >Editar</button>
      

     <form  style=" margin-left: 70px; margin-top:-33px" action="Departamento.blade.php" method="get" class="form-register" > 
     <button  type="submit" class="btn btn-warning" id="btnalta1" name="btnalta1" style="background-color: transparent border:0" data-toggle="modal"  value=<?php echo $ejecuta['idDep'] ?>>Alta</button>
     </form>
    </td>
  </tr>
...
<br>
 <select class="form-control" data-live-search="true" id=" nomcatego" name="nomcatego">
