  ...
  <form action="#" method="get" class="form-horizontal">
         ...
         <div class="col-md-3 col-md-offset-9" style="margin-top:15px; margin-left: 706px;"> <!--col-md-offset desplaza columnas a la derecha -->
                <div class="form-group">
                    ...
                    <input id="entradafilter1" type="text" class="form-control">
...
<thead>
    ...
    <th scope="col" style="color:#FFFFFF">Descripcion</th>
...
<?php
   ...
   ?>
    ...
    <td>
     ...
     <form  action="Comprar.blade.php" method="get" class="form-register" > 
