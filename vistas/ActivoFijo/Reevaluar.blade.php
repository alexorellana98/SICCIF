...
<?php
   ...
   ?>
    ...
    ?>
      ...
      <form  action="ReevaluarDetalle.blade.php" method="get" class="form-register" > 
      
<button  type="submit" class="btn btn-danger" id="btnId" name="btnId"  data-toggle="modal"  value=<?php echo $ejecuta['idAc']?>>Ver</button>
</form>

     <form style="margin-left: 60px; margin-top:-33px;" action="ReevaluarIngresa.blade.php" method="post" class="form-register" > 
