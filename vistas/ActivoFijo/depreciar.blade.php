	...
	<div class="col-md-8 col-md-offset-2 col-sm-12 col-xs-12">
		<div class="x_panel">
			...
			<div class="col-md-8 col-md-offset-3 col-sm-12 col-xs-12">
				...
				<button type="button" onclick="fecha()" class="btn btn-danger">CALCULAR</button>
				 <button type="button" onclick="calcular('1','0','0')" class="btn btn-info">AÑO</button>
				  <button type="button" onclick="calcular('2','0','0')" class="btn btn-info">MES</button>
				   <button type="button" onclick="calcular('3','0','0')" class="btn btn-info">DIAS</button>
