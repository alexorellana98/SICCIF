...
<script language="javascript">
  ...
  var cond= $("#condi").val();
  if (cond==1) {
     window.location="http://localhost/siccif/vistas/ActivoFijo/Marcas.blade.php";
  }else{window.location="http://localhost/siccif/vistas/ActivoFijo/MarcasInactivo.blade.php";}
...
<body class="hold-transition skin-green-light sidebar-mini">
 ...
 <div class="col-md-3"></div>
  ...
  <div class="col-md-9 col-md-offset-3" style=" margin-left: 288px;">
...
<option value="0">Inactivo </option>
 ...
 <div class="col-sm-12 col-md-12">
  ...
  <form action="#" method="get" class="form-horizontal">
         ...
         <div class="col-md-3 col-md-offset-9" style="margin-top:15px; margin-left: 697px;" > <!--col-md-offset desplaza columnas a la derecha -->
                <div class="form-group">
...
$cont=$cont+1;
  ...
  <tr>
    ...
    <td>
     ...
     <form  style="margin-left: 70px; margin-top:-33px;" action="Marcas.blade.php" method="get" class="form-register" > 
