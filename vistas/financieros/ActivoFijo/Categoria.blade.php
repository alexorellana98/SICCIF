...
<body class="hold-transition skin-green-light sidebar-mini">
  <div class="wrapper">
    ...
    <h3 align="center" >Gestionar Categorias</h3>
    </div>
    </div>
    </div>
    </div>  
...
{if (($ejecuta['estado'])==1) {
  ...
  <tr>
    ...
    <td>
     ...
     <form style=" margin-left: 70px; margin-top:-33px;" action="CategoriaInactivo.blade.php" method="get" class="form-register" > 
     <button  type="submit" class="btn btn-warning" id="btnbaja" name="btnbaja" style="background-color: transparent border:0" data-toggle="modal"  value=<?php echo $ejecuta['idCat'] ?>>Baja</button>
     </form>
    </td>
  </tr>
