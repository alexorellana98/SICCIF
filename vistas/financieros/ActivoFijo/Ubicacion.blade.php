...
<script language="javascript">
 ...
 function sele(){
  var cond= $("#condi").val();
  if (cond==1) {
     window.location="http://localhost/siccif/vistas/ActivoFijo/Ubicacion.blade.php";
  }else{window.location="http://localhost/siccif/vistas/ActivoFijo/UbicacionInactivo.blade.php";}
  ...
  <form action="#" method="get" class="form-horizontal">
         ...
         <div class="col-md-3 col-md-offset-9" style="margin-top:15px; margin-left: 706px;"> <!--col-md-offset desplaza columnas a la derecha -->
                <div class="form-group">
                    ...
                    <button type="submit" class="btn btn-success" style="margin-right:-20px;"><i class="glyphicon glyphicon-search"></i>
...
{ if (($ejecuta['estado'])==1) {
  ...
  <tr>
    ...
    <td>
    <form  action="editarUbicacion.blade.php" method="post" class="form-register" > 
     ...
     <form style="margin-left: 70px; margin-top:-33px;" action="UbicacionInactivo.blade.php" method="get" class="form-register" > 
