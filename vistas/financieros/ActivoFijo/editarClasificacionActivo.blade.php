...
<body class="hold-transition skin-green-light sidebar-mini">
 ...
 <header class="main-header">
  ...
  <?php include("menu.php"); ?> 
    ...
    <h3 align="center" >Editar Clasificacion</h3>
    </div>
    </div>
    </div>
    </div>  
...
<?php 
 ...
 <div class="col-lg-6 col-md-offset-3">
  ...
  <label for="nomAct2" >Nombre:</label>
  <div class="input-group">
  <input type="text" class="form-control" id="nomAct2" name="nomAct2" placeholder="Nombre" value="<?php echo $fila['nombre'];?>">
...
<div class="col-lg-6 col-md-offset-3">
  <label for="vida2">Años de vida útil:</label>
  <div class="input-group">
  <input type="number" class="form-control" id="vida2" name="vida2" min="0" value="<?php echo $fila['vida'];?>">
