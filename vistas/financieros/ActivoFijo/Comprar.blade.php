...
function sele(){
  ...
  }else{window.location="http://localhost/siccif/vistas/ActivoFijo/comprarInactivo.blade.php";}
...
<body class="hold-transition skin-green-light sidebar-mini">
  <div class="wrapper">
    ...
    <h3 align="center" >Adquisición de activo fijo</h3>
    </div>
    </div>
    </div>
    </div>  
...
if ($ejecuta['estadoBoton'] ==1) {
    ...
    ?>
      ...
      <form  action="vistaDetalleCompra.blade.php" method="get" class="form-register" > 
     ...
     <form style=" margin-left: 70px; margin-top:-33px;"  action="ComprarInactivo.blade.php" method="get" class="form-register" > 
