...
<body class="hold-transition skin-green-light sidebar-mini">
  <div class="wrapper">
    ...
    <h3 align="center" >Editar Departamento</h3>
    </div>
    </div>
    </div>
    </div>  
...
<?php 
 ...
 <div class="col-lg-8 col-md-offset-3">
  <label for="nombDe2" >Nombre:</label>
  <div class="input-group">
  <input type="text" class="form-control" id="nombDe2" name="nombDe2" placeholder="Nombre" value="<?php echo $fila['nombre'];?>">
...
<div class="col-lg-8 col-md-offset-3">
  <label for="cod2" >Código:</label>
  <div class="input-group">
  <input type="text" class="form-control" id="cod2" name="cod2" placeholder="Ejemplo : 0001" value="<?php echo $fila['codigo'];?>">
  <div class="input-group-addon"><span  class="glyphicon glyphicon-pencil" aria-hidden="true"></span></div>
</div>
</div>

</div>
<input  type="hidden" class="form-control" id="idDe" name="idDe" placeholder="Nombre" value="<?php echo $_POST['btnEditar'];?>">
