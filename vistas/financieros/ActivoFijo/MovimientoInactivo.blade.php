...
<script language="javascript">
  ...
  var cond= $("#condi").val();
  if (cond==1) {
     window.location="http://localhost/siccif/vistas/ActivoFijo/Movimiento.blade.php";
  }else{window.location="http://localhost/siccif/vistas/ActivoFijo/MovimientoInactivo.blade.php";}
...
$cont=$cont+1;
  ...
  <tr>
    ...
    <td>
      ...
      <button disabled="true" disabled="true"  type="submit" class="btn btn-danger" id="btnEditar" name="btnEditar" style="background-color: transparent border:0" data-toggle="modal"  value="<?php echo $ejecuta['idMov']?>" >Editar </button>
     
     <form  style="margin-left: 70px; margin-top:-33px;" action="Movimiento.blade.php" method="get" class="form-register" > 
     <button  type="submit" class="btn btn-warning" id="btnalta1" name="btnalta1" style="background-color: transparent border:0" data-toggle="modal"  value=<?php echo $ejecuta['idMov'] ?>>Alta </button>
     </form>
    </td>
  </tr>
